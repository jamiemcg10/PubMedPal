...
public class DatastoreBuilder {
	 ...
	 */
	public DatastoreBuilder (Document doc) throws IOException, ParseException {  // will be a w3c Document
		
		// initialize databases
		mysql = new MySQLDBInitializer();
		mongoDb = new MongoDBInitializer("records");
	 ...
	 */
	private void buildDatabase(Document doc) throws IOException, ParseException {
